...
export default function InstallerDetailsPage() {
  ...
  const [newWhatsappMessage, setNewWhatsappMessage] = useState<string | null>(
    null,
  );
  ...
  const handleResendPin = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setNewWhatsappMessage(data.data?.whatsappMessage || null);
        setNewWhatsappUrl(data.data?.whatsappUrl || null);
      ...
      <Dialog open={pinDialogOpen} onOpenChange={setPinDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex flex-col items-center gap-4 py-4">
            <div className="flex items-center gap-2">
              <div className="text-4xl font-number font-bold tracking-[0.25em] leading-none select-all">
                {newPin}
              </div>
              <CopyButton text={newPin || ""} label="PIN" className="size-5!" />
            </div>
          </div>
              ...
              <div className="flex gap-2">
                {newWhatsappUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg bg-green-700 text-white hover:bg-green-800 transition-colors"
                  >
                    <svg
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    navigator.clipboard.writeText(newWhatsappMessage);
