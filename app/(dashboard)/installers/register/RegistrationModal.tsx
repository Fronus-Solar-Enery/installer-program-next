...
export function RegistrationModal({
  ...
  useEffect(() => {
    ...
    const blocked =
      ...
      (deliveryMethod !== "free-form" && whatsappFailed && !pinResent);
    if (blocked) return;
              ...
              <div className="space-y-4 text-center">
                ...
                {deliveryMethod === "blocked" && (
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 space-y-3 text-left">
                    ...
                    <p className="text-xs text-muted-foreground">
                      The installer needs to send you a WhatsApp message first
                      to reopen the 24-hour window. Then click &quot;Resend
                      PIN&quot; to deliver credentials for free.
                    </p>
                    {whatsappMessage && (
                ...
                {deliveryMethod !== "free-form" &&
                  ...
                  !pinResent && (
                    <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 space-y-3 text-left">
                      ...
                      {!whatsappMessage && (
                        <p className="text-xs text-muted-foreground">
                          The installer needs this PIN to sign in. Click Resend
                          to generate and send a new PIN.
                        </p>
                      )}
                      <Button
                        size="sm"
