    ...
    <>
      {!fill ? (
        ...
        <svg className={`size-4 ${className}`} width="24"
          ...
          />
          <path
            d="M17.1001 18.1229L20.7664 21.7892C21.0487 22.0715 21.5064 22.0715 21.7887 21.7892C22.071 21.5069 22.071 21.0492 21.7887 20.7669L18.1224 17.1006C17.809 17.4676 17.4671 17.8095 17.1001 18.1229Z"
            fill="currentColor"
          />
        </svg>
      ) : (
