    ...
    <>
      {!fill ? (
        ...
        <svg className={`size-4 ${className}`} width="24"
          ...
          />
          <path
            d="M6.75 10.5C6.75 10.9142 7.08579 11.25 7.5 11.25H10.5C10.9142 11.25 11.25 10.9142 11.25 10.5V7.5C11.25 7.08579 10.9142 6.75 10.5 6.75C10.0858 6.75 9.75 7.08579 9.75 7.5V8.68934L7.53033 6.46967C7.23744 6.17678 6.76256 6.17678 6.46967 6.46967C6.17678 6.76256 6.17678 7.23744 6.46967 7.53033L8.68934 9.75H7.5C7.08579 9.75 6.75 10.0858 6.75 10.5Z"
            fill="currentColor"
          />
          <path
          ...
          />
          <path
            d="M6.46967 16.4697C6.17678 16.7626 6.17678 17.2374 6.46967 17.5303C6.76256 17.8232 7.23744 17.8232 7.53033 17.5303L9.75 15.3107V16.5C9.75 16.9142 10.0858 17.25 10.5 17.25C10.9142 17.25 11.25 16.9142 11.25 16.5V13.5C11.25 13.0858 10.9142 12.75 10.5 12.75H7.5C7.08579 12.75 6.75 13.0858 6.75 13.5C6.75 13.9142 7.08579 14.25 7.5 14.25H8.68934L6.46967 16.4697Z"
            fill="currentColor"
          />
          <path
            d="M17.5303 16.4697C17.8232 16.7626 17.8232 17.2374 17.5303 17.5303C17.2374 17.8232 16.7626 17.8232 16.4697 17.5303L14.25 15.3107V16.5C14.25 16.9142 13.9142 17.25 13.5 17.25C13.0858 17.25 12.75 16.9142 12.75 16.5V13.5C12.75 13.0858 13.0858 12.75 13.5 12.75H16.5C16.9142 12.75 17.25 13.0858 17.25 13.5C17.25 13.9142 16.9142 14.25 16.5 14.25H15.3107L17.5303 16.4697Z"
            fill="currentColor"
          />
        </svg>
      ) : (
