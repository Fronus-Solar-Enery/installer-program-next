    ...
    <>
      {!fill ? (
        <svg className={`size-4 ${className}`} width="25"
          ...
          <path
            d="M22.6699 12C22.6699 17.52 18.1899 22 12.6699 22C7.14992 22 2.66992 17.52 2.66992 12C2.66992 6.48 7.14992 2 12.6699 2C18.1899 2 22.6699 6.48 22.6699 12Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          ...
          <path
            ...
            d="M16.3798 15.18L13.2798 13.33C12.7398 13.01 12.2998 12.24 12.2998 11.61V7.51001"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <svg className={`size-4 ${className}`} width="25"
          ...
          />
          <path
            d="M16.3796 15.93C16.2496 15.93 16.1196 15.9 15.9996 15.82L12.8996 13.97C12.1296 13.51 11.5596 12.5 11.5596 11.61V7.51001C11.5596 7.10001 11.8996 6.76001 12.3096 6.76001C12.7196 6.76001 13.0596 7.10001 13.0596 7.51001V11.61C13.0596 11.97 13.3596 12.5 13.6696 12.68L16.7696 14.53C17.1296 14.74 17.2396 15.2 17.0296 15.56C16.8796 15.8 16.6296 15.93 16.3796 15.93Z"
            fill="currentColor"
          />
        </svg>
      ) : (
