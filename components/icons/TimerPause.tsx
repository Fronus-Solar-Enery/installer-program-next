...
const IconTimerPause: FC<IconProps> = ({
  className,
  fill = false,
  duotone = false,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        <svg className={`size-4 ${className}`} width="25"
          ...
          />
          <path
            d="M15.5596 3.45H9.77957C9.37957 3.45 9.05957 3.13 9.05957 2.73C9.05957 2.33 9.37957 2 9.77957 2H15.5596C15.9596 2 16.2796 2.32 16.2796 2.72C16.2796 3.12 15.9596 3.45 15.5596 3.45Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.4" : "1"}
          ...
          />
          <path
            d="M20.6399 15H17.7099C16.4299 15 15.6699 15.76 15.6699 17.03V19.96C15.6699 21.23 16.4299 21.99 17.6999 21.99H20.6299C21.8999 21.99 22.6599 21.23 22.6599 19.96V17.03C22.6699 15.76 21.9099 15 20.6399 15ZM18.5899 20.06C18.5899 20.38 18.3299 20.64 18.0099 20.64C17.6899 20.64 17.4299 20.38 17.4299 20.06V16.95C17.4299 16.63 17.6899 16.37 18.0099 16.37C18.3299 16.37 18.5899 16.63 18.5899 16.95V20.06ZM20.9199 20.06C20.9199 20.38 20.6599 20.64 20.3399 20.64C20.0199 20.64 19.7599 20.38 19.7599 20.06V16.95C19.7599 16.63 20.0199 16.37 20.3399 16.37C20.6599 16.37 20.9199 16.63 20.9199 16.95V20.06Z"
            fill="currentColor"
          />
        </svg>
      ) : (
