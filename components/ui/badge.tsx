  ...
  "inline-flex items-center justify-center rounded-md border border-border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden font-mono select-none",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-emerald-500 text-white dark:bg-emerald-950/50 dark:text-emerald-400 focus-visible:outline-emerald-700 focus-visible:dark:outline-emerald-200",

        warning:
          "border-transparent bg-yellow-400 text-yellow-950 dark:bg-yellow-950/40 dark:text-yellow-500 focus-visible:outline-yellow-700 focus-visible:dark:outline-yellow-300",
      },
    },
    defaultVariants: {
      variant: "default",
