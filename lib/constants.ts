...
export const PAKISTAN_LOCATION_DATA: ProvinceLocationData[] = [
  ...
  },
  {
    ...
    districts: {
      ...
      "Dera Ghazi Khan": { code: "DGK", cities: ["Dera Ghazi Khan", "Mamoori"] },
      Faisalabad: { code: "FSD", cities: ["Faisalabad", "Jaranwala", "Soianwala"] },
      Gujranwala: {
        code: "GRW",
        cities: [
          "Gujranwala",
      ...
      "Mandi Bahauddin": { code: "MBD", cities: ["Mandi Bahauddin", "Chillianwala", "Malakwal"] },
      Mianwali: { code: "MWL", cities: ["Mianwali", "Kalabagh"] },
      Multan: { code: "MUX", cities: ["Multan"] },
      Murree: { code: "MUR", cities: ["Murree"] },
      Muzaffargarh: { code: "MZG", cities: ["Muzaffargarh", "Alipur", "Jatoi"] },
      "Nankana Sahib": { code: "NNS", cities: ["Nankana Sahib", "Sangla Hill"] },
      ...
      Rawalpindi: { code: "RWP", cities: ["Rawalpindi", "Gujar Khan", "Taxila", "Wah Cantonment"] },
      ...
      "Toba Tek Singh": { code: "TTS", cities: ["Toba Tek Singh", "Gojra", "Kamalia", "Pir Mahal"] },
  ...
  },
  {
    ...
    districts: {
      ...
      Larkana: { code: "LRK", cities: ["Larkana", "Dokri", "Naudero", "Ratodero"] },
      ...
      "Qambar Shahdadkot": { code: "QSK", cities: ["Qambar", "Shahdadkot", "Warah"] },
      Sanghar: { code: "SGR", cities: ["Sanghar", "Shahdadpur", "Shahpur Chakar", "Tando Adam Khan"] },
      ...
      Tharparkar: { code: "TPR", cities: ["Diplo", "Islamkot", "Mithi", "Nagarparkar"] },
  ...
  },
  {
    ...
    districts: {
      ...
      "Dera Ismail Khan": { code: "DIK", cities: ["Dera Ismail Khan", "Kulachi", "Paharpur"] },
      ...
      Shangla: { code: "SGL", cities: ["Shangla", "Alpuri", "Bisham", "Martung"] },
      "South Waziristan": { code: "SWS", cities: ["Wana", "Spinkai"] },
      Swabi: { code: "SWB", cities: ["Swabi", "Shewa Adda", "Tordher"] },
      Swat: { code: "SWT", cities: ["Swat", "Madyan", "Mingora", "Saidu Sharif"] },
